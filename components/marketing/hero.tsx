            ...
            <div className="flex flex-col items-center justify-center gap-y-8 relative">
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
                    <Container className="relative hidden lg:block overflow-hidden">
                        <Link href="https://www.techrepublic.com/article/hiring-and-recruiting-trends/" target="_blank" className="relative group flex items-center justify-center w-fit px-3 py-1 rounded-full shadow-md transition-colors duration-200 mx-auto">
                            <span>
                            ...
                            <span className="z-10 py-0.5 text-sm text-blue-600 flex items-center">
                                ...
                                Discover Insights for 2025 Hiring Trends
                            </span>
                        </Link>
                    </Container>
                    ...
                    <Container delay={0.2}>
                        <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
                            AI-powered resume building and ATS analysis to enhance your job applications and secure the role you deserve.
                        </p>
                    </Container>
