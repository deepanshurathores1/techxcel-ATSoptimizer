                ...
                <Container>
                    <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                            Choose the perfect plan to <br className="hidden lg:block" /> <span className="font-subheading italic">boost your career</span>
                        </h2>
                        <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                            Optimize your resume with AI-powered analysis. Get instant feedback, increase your ATS score, and land your dream job faster.
                        </p>
                    </div>
                </Container>
...
const Plan = ({ plan, billPlan }: { plan: PLAN, billPlan: Plan }) => {
    return (
        <div className={cn(
            ...
            plan.title === "Premium" && "border-blue-500"
        )}>
            {plan.title === "Premium" && (
            ...
            <div className="flex flex-col items-start w-full px-4 py-2 md:px-8">
                <Button size="lg" variant={plan.title === "Premium" ? "blue" : "white"} className="w-full">
                    {plan.buttonText}
                </Button>
